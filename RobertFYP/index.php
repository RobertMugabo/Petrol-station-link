        ...
        <ul>
          ...
          <li class="nav-item dropdown">
           <a class="nav-link dropdown-toggle" href="#" id="notificationsDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-item">No notifications yet</div>
            </div>
          </li>
          <li><a href="inner/signup.php" style="background-color:#f03c02; border-radius:20px; margin-left:20px; text-align: center; align-items: center;padding:10px;color:white;">SignUp/Login</a></li>
          <li>
            <a href="../RobertFYP Kinyarwanda/index.php" style="color:orange; border-radius:20px; margin-left:20px; text-align: center; align-items: center;padding:10px;">
              <img src="assets/img/rwanda-flag-icon.png" alt="Rwandan Flag" title="Translate to Kinyarwanda" style="height:20px;">
            </a>
          </li>
  ...
  <section id="hero">
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/three.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Welcome to <span>PETROL STATION LINK</span></h2>
              <p>Your trusted partner for quality fuel and excellent customer service.</p>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/2.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Reliable Fuel Supply</h2>
              <p>We ensure a steady and reliable supply of high-quality fuel for your needs.</p>
              <div class="text-center"><a href="#services" class="btn-get-started">Read More</a></div>
            </div>
          </div>
        </div>
        ...
        <!-- Slide 3 -->
        <div class="carousel-item" style="background-image: url(assets/img/fuel.jpg);">  
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Exceptional Service</h2>
              <p>Our team is dedicated to providing top-notch customer service every day.</p>
              <div class="text-center"><a href="#services" class="btn-get-started">Read More</a></div>
            </div>
          </div>
        </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2><strong>Services available at the station</strong></h2>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box" data-aos="fade-up">
              ...
              <h4 class="title"><a href="">Fuel Supply</a></h4>
              <p class="description">High-quality petrol, diesel, and kerosene available 24/7.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bi bi-car-wash"></i></div>
              <h4 class="title"><a href="">Car Wash</a></h4>
              <p class="description">Professional car wash services to keep your vehicle spotless.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="500">
              ...
              <p class="description">We ensure the highest quality in all our services.</p>
            </div>
          </div>
        </div>
...
<section id="about" class="skills">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      ...
      <p>Our team possesses a diverse set of skills essential for driving innovation and excellence in the petroleum sector. We continuously enhance our expertise to meet the challenges and opportunities in the industry.</p>
    </div>
    ...
    <div class="row skills-content">
      ...
      <div class="col-lg-6" data-aos="fade-up">
        ...
        <div class="progress">
          <span class="skill">Oil & Gas Engineering <i class="val">95%</i></span>
        ...
        <div class="progress">
          <span class="skill">Data Analysis <i class="val">85%</i></span>
          <div class="progress-bar-wrap">
        ...
        <div class="progress">
          <span class="skill">Record monitoring <i class="val">80%</i></span>
          <div class="progress-bar-wrap">
...
<section id="team" class="team section-bg">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      ...
      <p>Meet the dedicated professionals driving our mission to revolutionize the petroleum industry. Each team member brings unparalleled expertise and passion to our project, ensuring we deliver excellence in every aspect of our operations.</p>
    </div>

    <div class="row">
  <div class="col-lg-3 col-md-6 d-flex align-items-stretch" style="margin-left:350px;">
    <div class="member" data-aos="fade-up">
      <div class="member-img">
        ...
        <div class="social">
          ...
          <a href="https://www.linkedin.com/in/mugabo-robert-76470428b/"><i class="bi bi-linkedin"></i></a>
        </div>
      </div>
  ...
  <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
    <div class="member" data-aos="fade-up" data-aos-delay="100">
      <div class="member-img">
        <img src="assets/img/jospin.jpg" class="img-fluid" alt="">
        <div class="social">
          <a href="https://x.com/JospinRafiki"><i class="bi bi-twitter"></i></a>
          <a href="https://www.facebook.com/jospin.rafiki.5/"><i class="bi bi-facebook"></i></a>
          <a href="https://www.instagram.com/joe__roman/"><i class="bi bi-instagram"></i></a>
          <a href="https://www.linkedin.com/in/rafiki-jospin-165034322/"><i class="bi bi-linkedin"></i></a>
        </div>
      </div>
      <div class="member-info">
        <h4>RAFIKI Jospin</h4>
...
<section id="testimonials" class="testimonials">
  <div class="container">
    ...
    <div class="section-title" data-aos="fade-up">
      ...
      <p>Our clients value our commitment to excellence in the petroleum industry. Here’s what they have to say about our services and solutions.</p>
    </div>
          ...
          <div class="col-lg-6">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Kigali, Gasabo District, Rwanda</p>
              </div><br>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>info@petrolstationliink.com</p>
              </div><br>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p>+250 789 438 711 <br> +250 788 213 553
                 </div>
            </div>
          </div>
...
try {   
  ...
  if (isset($_POST['send'])) {
    ...
    $insert = $connect->prepare("INSERT INTO `messages`(`name`, `email`, `subject`, `message`) VALUES (:name, :email, :subject, :message)");
    $insert->execute([
      ':name' => $name,
      ':email' => $email,
      ':subject' => $subject,
   ...
   if ($insert) {
    ...
    echo "<script>alert('Un expected error sending message')</script>";
    }
  } 
